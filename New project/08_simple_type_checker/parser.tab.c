...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_type_spec = 22,                 /* type_spec  */
...
{
       0,    84,    84,    86,    90,    91,    92,    96,   105,   120,
     121,   125,   126,   127,   131,   132,   133,   137,   138,   139,
     140
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "FLOAT", "IVAL",
  "FVAL", "ID", "'+'", "'-'", "'*'", "'/'", "'\\n'", "';'", "'='", "'('",
  "')'", "$accept", "input", "line", "declaration", "assignment",
  "type_spec", "expr", "term", "factor", YY_NULLPTR
};
...
{
     -10,     0,   -10,   -10,   -10,     8,   -10,   -10,    -1,    11,
      17,     3,   -10,   -10,    12,   -10,   -10,   -10,     3,     6,
      -9,   -10,   -10,    -3,     3,     3,   -10,     3,     3,   -10,
      -9,    -9,   -10,   -10
};
...
{
       2,     0,     1,     9,    10,     0,     6,     3,     0,     0,
       0,     0,     4,     5,     0,    18,    19,    20,     0,     0,
      13,    16,     7,     0,     0,     0,     8,     0,     0,    17,
      11,    12,    14,    15
};
...
{
       2,    27,    28,     3,     4,    24,    25,     5,    15,    16,
      17,    12,     6,    29,    24,    25,    30,    31,    18,    26,
      32,    33,    11,    13,    14,    22,     0,    23
};

static const yytype_int8 yycheck[] =
{
       0,    10,    11,     3,     4,     8,     9,     7,     5,     6,
       7,    12,    12,    16,     8,     9,    24,    25,    15,    13,
      27,    28,    14,    12,     7,    13,    -1,    18
};
...
{
       0,    18,     0,     3,     4,     7,    12,    19,    20,    21,
      22,    14,    12,    12,     7,     5,     6,     7,    15,    23,
      24,    25,    13,    23,     8,     9,    13,    10,    11,    16,
      24,    24,    25,    25
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* declaration: type_spec ID ';'  */
#line 97 "parser.y"
    {
        declare_symbol((yyvsp[-1].id), (yyvsp[-2].type));
        printf("Declared %s as %s\n", (yyvsp[-1].id), (yyvsp[-2].type) == TYPE_INT ? "int" : "float");
        free((yyvsp[-1].id));
    }
#line 1161 "parser.tab.c"
    break;

  case 8: /* assignment: ID '=' expr ';'  */
#line 106 "parser.y"
    {
        int lhs = get_symbol_type((yyvsp[-3].id));
        if (lhs == TYPE_ERROR) {
            fprintf(stderr, "Undeclared variable: %s\n", (yyvsp[-3].id));
        } else if (!compatible(lhs, (yyvsp[-1].type))) {
...
#line 125 "parser.y"
                    { (yyval.type) = promote((yyvsp[-2].type), (yyvsp[0].type)); }
...
#line 141 "parser.y"
    {
        (yyval.type) = get_symbol_type((yyvsp[0].id));
        if ((yyval.type) == TYPE_ERROR) {
            fprintf(stderr, "Undeclared variable: %s\n", (yyvsp[0].id));
        }
        free((yyvsp[0].id));
    }
