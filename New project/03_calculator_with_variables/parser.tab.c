...
{
      -5,     0,    -5,    -5,    -4,    -5,    -2,    -5,     9,    17,
      -5,    -2,    -5,     1,    -2,    -2,    -5,    -2,    -2,    11,
      -5,    17,    17,    -5,    -5,    -5
};
...
{
       2,     0,     1,    14,    15,     6,     0,     3,     0,     9,
      12,     0,    15,     0,     0,     0,     5,     0,     0,     0,
      13,     7,     8,    10,    11,     4
};
...
{
       2,     3,    12,     3,     4,    11,    14,    15,     0,     6,
       5,     6,     0,    20,    14,    15,    14,    15,    13,    16,
       0,    25,     0,    19,    17,    18,     0,    21,    22,     0,
       0,    23,    24
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,     9,     5,     6,    -1,    11,
      10,    11,    -1,    12,     5,     6,     5,     6,     6,    10,
      -1,    10,    -1,    11,     7,     8,    -1,    14,    15,    -1,
      -1,    17,    18
};
...
{
       0,    14,     0,     3,     4,    10,    11,    15,    16,    17,
      18,     9,     4,    16,     5,     6,    10,     7,     8,    16,
      12,    17,    17,    18,    18,    10
};
...
#line 64 "parser.y"
    {
        assign_value((yyvsp[-3].id), (yyvsp[-1].num));
...
#line 100 "parser.y"
    {
        int found;
        (yyval.num) = lookup((yyvsp[0].id), &found);
        if (!found) {
