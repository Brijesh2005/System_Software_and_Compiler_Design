...
{
  "\"end of file\"", "error", "\"invalid token\"", "RELOP", "NUMBER",
  "ID", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "input",
  "relation", "expr", YY_NULLPTR
};
...
{
      14,    -6,    -6,    14,     5,    -6,     8,    19,    -6,    14,
      14,    14,    14,    14,    -6,    -5,     4,     4,    -6,    -6
};
...
{
       7,    10,    11,    12,    13,     8,    15,    16,    17,    18,
      19,     9,    12,    13,    10,    11,    12,    13,     1,     2,
...
{
       3,     6,     7,     8,     9,     0,     9,    10,    11,    12,
      13,     3,     8,     9,     6,     7,     8,     9,     4,     5,
